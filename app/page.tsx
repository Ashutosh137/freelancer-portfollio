...
export default function Home() {
  return (
    <div className=" ">
      <Navbar />
      <SparklesCore background={"re"} maxSize={2} className="w-full fixed inset-0  bg-opacity-40 -z-10" />
      <ImageSlider className="h-[90vh]  w-full" images={[image1, image3, image4, image5, image6]}>
        <motion.div
          initial={{
            opacity: 0,
            y: -80,
      ...
      <Marquee pauseOnHover repeat={5}>
        ...
        <article className="mx-10 max-w-md border rounded-xl p-5 py-3">
