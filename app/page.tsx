...
import { SparklesCore } from "@/components/sprkals";
...
export default function Home() {
  return (
    <div className=" ">
      <FloatingNav />
      <SparklesCore maxSize={2} className="w-full fixed inset-0 h-full  bg-opacity-40 -z-10" />
      <ImageSlider className="h-[100vh]  w-full" images={[image1, image3, image4, image5, image6]}>
        <motion.div
          initial={{
            opacity: 0,
            y: -80,
      ...
      <section id="connect" className="h-screen flex flex-col align-middle justify-center">
        <h1 className="text-6xl mb-10 text-center capitalize text-black ">connect us</h1>
        <PlaceholdersAndVanishInput onChange={(e) => { }} onSubmit={() => { }} placeholders={["enter your email address"]} />
      </section>
